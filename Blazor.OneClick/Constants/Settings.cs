...
namespace Blazor.OneClick.Constants
{
    ...
    {
        public static string ConnectionString = "Server=" + Environment.MachineName + "\\SQLEXPRESS;Database=OneClickWeb;User Id=monster;Password=qwerty111222333;Trusted_Connection=no;TrustServerCertificate=True;";
